...
/* менеджер, хранящий и ищущий билеты */
public class AviaSouls {
    ...
    /**
     * Метод поиска билетов по маршруту и их сортировка
    ...
    /**
     * Метод поиска билетов по маршруту и их сортировка по задаваемой логике
     * @param from Откуда вылетаем
     * @param to Куда прилетаем
     * @param comparator Логика сортировки массива
     * @return Массив из подходящих билетов
     */
